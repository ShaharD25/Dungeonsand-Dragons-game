...
public class GameMap {
     ...
     */
    public List<GameEntity> getEntitiesAt(Position pos) {return grid.getOrDefault(pos, Collections.emptyList());}
     ...
     */
    public boolean isValidPosition(Position pos) {return pos.getRow() >= 0 && pos.getCol() >= 0;}
